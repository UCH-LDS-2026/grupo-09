...
export function Metric({ label, value, icon: Icon, accent }: MetricProps) {
  ...
  return (
    <div className="min-h-20 rounded-md border border-border/60 bg-card/60 p-3 sm:min-h-24 sm:p-3.5">
      ...
      <div
        className="break-words font-mono text-lg font-semibold tracking-tight sm:text-xl"
        style={{ color }}
      >
        {value}
      </div>
