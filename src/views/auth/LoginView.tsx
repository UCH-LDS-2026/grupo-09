...
export function LoginView({ error, isSubmitting, onLogin }: LoginViewProps) {
  const [email, setEmail] = useState("admin@sistema.test");
    ...
    <main className="min-h-screen bg-background text-foreground">
      <div className="grid min-h-screen lg:grid-cols-[1.05fr_0.95fr]">
        <section className="relative hidden overflow-hidden border-r border-border/60 bg-panel/40 lg:block">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_55%_45%,color-mix(in_oklab,var(--neon-cyan)_16%,transparent),transparent_34%),radial-gradient(circle_at_30%_70%,color-mix(in_oklab,var(--neon-violet)_12%,transparent),transparent_30%)]" />
          ...
          <div className="relative flex h-full flex-col justify-between p-10">
            ...
            <div className="max-w-xl">
              ...
              <p className="mt-5 max-w-lg text-base leading-7 text-muted-foreground">
                Este primer módulo protege el acceso al canvas y deja preparada la base para roles,
                proyectos y persistencia real.
              </p>
            </div>
            ...
            <div className="rounded-lg border border-border/70 bg-panel/80 p-6 shadow-[var(--shadow-glow-cyan)] backdrop-blur">
              <div className="mb-7">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Accede al entorno gráfico de arquitectura.
                </p>
              </div>
              ...
              <div className="mt-5 rounded-md bg-card/70 p-3 font-mono text-[11px] text-muted-foreground">
                demo: admin@sistema.test / admin123
              </div>
            </div>
          </div>
        </section>
